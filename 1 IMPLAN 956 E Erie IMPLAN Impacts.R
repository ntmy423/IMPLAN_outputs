### 956 E Erie EIS Impacts - March 2025 ###
...
# # eg mac
# setwd("~/Library/CloudStorage/OneDrive-EconsultSolutionsInc/956 E Erie EIS General/Analysis/IMPLAN")

# eg work comp
setwd("C:/Users/egoldstein/OneDrive - Econsult Solutions Inc/956 E Erie EIS General/Analysis/IMPLAN")
...
geography <- list(
  c("Philadelphia County, PA (2023)"), 
  c("Philadelphia County, PA (2023)", "PA minus Philadelphia County (2023)")
)
...
event_groups <- trimws(c("CapExSingle ", "CapExMulti ", "OpsManufacturing ", "OpsWarehousing "
                         ))
...
# saveWorkbook(wb, "Processed/Statewide_Employment_Summary.xlsx", overwrite = TRUE)
