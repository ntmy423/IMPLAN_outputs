...
implan_output_file_name = "20260310-Montana_2024-Detail Economic Indicators.csv"
...
region_names = unique(raw_output$DestinationRegion)
...
geography_list = c(region_names)
geography = c(as.list(region_names), list(region_names))
...
write.csv(output_economic_impact, "output_files/20260310_2024_Montana_economicimpact_tables.csv", na = "", row.names = FALSE)
write.csv(output_industry_distribution, "output_files/20260310_2024_Montana_industryemployment_distribution.csv", na = "", row.names = FALSE)
