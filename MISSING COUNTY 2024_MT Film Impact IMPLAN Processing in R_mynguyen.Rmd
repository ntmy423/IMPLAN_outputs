...
working_dir = "C:/Users/mnguyen/OneDrive - Econsult Solutions Inc/Montana Film Industry EIS - 5-Analysis/IMPLAN - Film Impact" #set working director to the project IMPLAN Folder

industry = "528"  # set IMPLAN NAICS industry classification (528 or 546)

implan_output_file_name = "20260310-Missing County_2024-Detail Economic Indicators.csv"
...
geography_list = c("MISSING COUNTY","Montana")
geography = list(c("MISSING COUNTY"),
  c("MISSING COUNTY","Montana (2024)"))

# define the geographies which you want to include in industry employment distribution tables
industry_distribution_geography = c("MISSING COUNTY","Montana(2024)")
```
...
write.csv(output_economic_impact, "output_files/20260310_2024_Missing County_economicimpact_tables.csv", na = "", row.names = FALSE)
write.csv(output_industry_distribution, "output_files/20260310_2024_Missing County_industryemployment_distribution.csv", na = "", row.names = FALSE)
